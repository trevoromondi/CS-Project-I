...
if(isset($_POST["submit"]))
{
    ...
    $insert= $mysqli->query ("INSERT INTO missing_persons(victim_name, age, last_seen, locations, descriptions) VALUES('$victim_name', '$age','$last_seen', '$locations', '$descriptions')");
...
<html lang="en">
    ...
    <nav class="navbar navbar-style">
        ...
        <div class="container">
            <div>
                <h2 class="text-center mb-5 shadow-sm p-3">Emergency Alert Message- Missing Person</h2>
            </div>
