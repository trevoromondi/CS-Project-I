                ...
                <div class="col-lg-7 px-5 pt-5">
                    ...
                    <div class="form-row">
                        <div class="col-lg-7">
                            ...
                            <input type="number" name="alertID" value="" id="alertID" value="<?php echo $data['alertID']?>" class="form-control my-3 p-4">
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <label class="form-label">Alert</label>
                         <textarea name="alertDescription" class="form-control" value="<?php echo $data['alertDescription']?>" rows="3"></textarea>
                    </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="col-lg-7">
                            <input type="text" name="officer_id" value="" id="officer_id" value="<?php echo $data['officer_id']?>" class="form-control my-3 p-4">
                        </div>
                    </div>
