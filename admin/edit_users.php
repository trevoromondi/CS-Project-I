...
<head>
  ...
  <title>RED | Edit/Disable Users</title>
...
<li class="nav-item">
  ...
  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      <h6 class="collapse-header">Customize User Profiles:</h6>
      <a class="collapse-item" href="view_users.php">View Users</a>
      <a class="collapse-item" href="edit_users.php">Edit/Disable User</a>
    </div>
  </div>
</li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Edit/Disable User Accounts</h1>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Select The "Logout" Button Below If You Are Ready To Leave.</div>
