...
if(isset($_POST["submit"]))
{
    ...
    $insert= $mysqli->query ("INSERT INTO fire_alerts(fire_type, category, locations, district, road, descriptions) VALUES('$fire_type', '$category', '$locations', '$district', '$road', '$descriptions')");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div>
                <h2 class="text-center mb-5 shadow-sm p-3">Emergency Alert Message- Fire Emergency</h2>
            </div>
